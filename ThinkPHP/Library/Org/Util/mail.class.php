...
define("SMTP_USER", "18482182989");//SMTP服务器的用户帐号
define("SMTP_PASS", "12280ZHIabout");//SMTP服务器的用户密码
$from = "18482182989@163.com";//SMTP服务器的用户邮箱
$to = "1228042983@qq.com";//发送给谁 可用逗号隔开多个邮箱
$cc = "aa";
$bcc = "c";
$subject="这是一个由PHP发送的带附件的邮件";//邮件主题 很多客户端会有乱码，所以转一下码
$body = "这个是一个带附件的邮件发送程序<hr>看到没";//邮件内容
