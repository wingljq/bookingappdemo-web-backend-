            ...
            <div class="col-lg-3 col-md-12" style="    padding-bottom: 15%;    flex: 0 0 25%;">
                <div class="shop-category">
                    <div class="category-title">
                        <a href="#"><?php echo L('cate');?></a>
                    </div>

                    <div class="shop-category-menu">
                        <ul class="category-list">
                            <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="">
                                    <a href="<?php echo U('index/cate');?>?id=<?php echo ($vo["cateId"]); ?>" class="nav-link" style="color:#CCD5AE">
                                        <?php echo ($vo["name"]); ?>
                                    </a>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div v-for="(item, key) in goods" class="shop-item-box" style="flex: 45%;margin:20px">
                    <div class="row align-items-center">
                        <div class="col-lg col-sm">
                            <a :href="'<?php echo U('index/detail');?>?id='+item.id">
                                ...
                                <ul class="shop-btn-list">
                                    ...
                                    <li>
                                        <a @click="addCart(item.id)">
                                            <i class="flaticon-shopping-cart"></i><?php echo L('AddToCart');?>
                                        </a>

                                    </li>
                                    <li>
                                        <a class="item.id" @click="remove(item.id)"><?php echo L('AddToWishlist');?></a>
                                    </li>
                                    <li>
        ...
        new Vue({
            ...
            methods: {
                pageLoad: function (page) {
                    ...
                    if (urlParams.get('id')) {
                        urlStr = "<?php echo U('goods/getAllGoods');?>?pagesize=" + this.page_size + "&page=" + page + '&cateId=' + urlParams.get('id')
                    } else {
                        urlStr = "<?php echo U('goods/getAllGoods');?>?pagesize=" + this.page_size + "&page=" + page
                    }
                    $.ajax({
                        url: urlStr,
                        data: {
                ...
                addCart: function (id) {
                    $.ajax({
                        ...
                        success: function (json) {
                            if (json.code == '0') {
                                layer.msg("<?php echo L('success');?>");
                            } else if (json.code == '2001') {
                                layer.msg("<?php echo L('pleaseLogin');?>");
                            }
                        }
                    })
                },
