...
<section class="products-details-area ptb-100">
    <div class="container" id="app">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-12">
                            <div class="main-products-image">
                                <img style="width:260px;height:260px" src="<?php echo ($goodsInfo["coverImg"]); ?>" alt="image">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="product-content">
                                ...
                                <div class="price">
                                    ...
                                    <p class="new-price">$<?php echo ($goodsInfo["price"]); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        height: 130px;">
                            ...
                            <div class="product-add-to-cart">
                                <?php if($_SESSION['uid']): ?><button class="default-btn" @click="addCart(<?php echo ($goodsInfo["id"]); ?>)"
                                        onmouseover="this.setAttribute('style', );"
                                        onmouseout="this.setAttribute('style',)">
                                        <i class="fa fa-shopping-cart"></i>
                                        <?php echo L('addToCart');?>
                                        <span></span>
                                    </button>
                                    <?php else: ?>
                                    <a href="<?php echo U('account/login');?>" class="default-btn"
                                        onmouseover="this.setAttribute('style', );"
                                        onmouseout="this.setAttribute('style',)">
                                        <i class="fa fa-shopping-cart"></i>
                                        <?php echo L('addToCart');?>
                            ...
                            <?php if($_SESSION['uid']): ?><button class="default-btn" @click="toggleFav(<?php echo ($goodsInfo["id"]); ?>)"
                                    onmouseover="this.setAttribute('style',);"
                                    onmouseout="this.setAttribute('style', )">
                                    <i class="fa fa-heart"></i>
                                    <?php echo L('AddToWishlist');?>
                                    <span></span>
                                </button>
                                <?php else: ?>
                                <a href="<?php echo U('account/login');?>" class="default-btn"
        ...
        box-shadow: 5px 3px 12px -1px;margin-top: 5%;;">
            <p style="color: #2F4858;"><?php echo L('details');?></p>
            <br />
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel">
                    <!-- <h2>Overview</h2> -->

                    <?php echo ($goodsInfo["desc"]); ?>
                </div>
